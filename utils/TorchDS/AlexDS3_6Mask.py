...
class MRITorchDS(Dataset):
    ...
    def CreateImageBase(self, fullyContrast='PD', underContrast='T2', plane='axial', volNo = '1'):
        ...
        for folder in subfolders_fully:
            subject = folder
            imagenameNoExtFully = fullyContrast + '_' + plane + '_' + volNo
            imagenameNoExtUnder = underContrast + '_' + plane + '_' + volNo
            ...
            fullpaths_file_under.append(os.path.join(self.root_under, subject, undersampledImageNameCh1))
            undersampledImageNameCh2 = imagenameNoExtUnderCh2+'.'+self.fileExtension_under 
            fullpaths_file_under.append(os.path.join(self.root_under, subject, undersampledImageNameCh2))
            undersampledImageNameCh3 = imagenameNoExtUnderCh3+'.'+self.fileExtension_under 
            fullpaths_file_under.append(os.path.join(self.root_under, subject, undersampledImageNameCh3))
            undersampledImageNameCh4 = imagenameNoExtUnderCh4+'.'+self.fileExtension_under 
            fullpaths_file_under.append(os.path.join(self.root_under, subject, undersampledImageNameCh4))
            undersampledImageNameCh5 = imagenameNoExtUnderCh5+'.'+self.fileExtension_under 
            fullpaths_file_under.append(os.path.join(self.root_under, subject, undersampledImageNameCh5))
            undersampledImageNameCh6 = imagenameNoExtUnderCh6+'.'+self.fileExtension_under 
            fullpaths_file_under.append(os.path.join(self.root_under, subject, undersampledImageNameCh6))

            imagenameNoExtFullyCh1 = imagenameNoExtFully + '_First_channel'
            imagenameNoExtFullyCh2 = imagenameNoExtFully + '_Second_channel'
            imagenameNoExtFullyCh3 = imagenameNoExtFully + '_Third_channel'
            imagenameNoExtFullyCh4 = imagenameNoExtFully + '_Fourth_channel'
            imagenameNoExtFullyCh5 = imagenameNoExtFully + '_Fifth_channel'
            imagenameNoExtFullyCh6 = imagenameNoExtFully + '_Sixth_channel'
            fullyImageNameCh1 = imagenameNoExtFullyCh1+'.'+self.fileExtension_under 
            fullpaths_file_fully.append(os.path.join(self.root_fully, subject, fullyImageNameCh1))
            fullyImageNameCh2 = imagenameNoExtFullyCh2+'.'+self.fileExtension_under 
            fullpaths_file_fully.append(os.path.join(self.root_fully, subject, fullyImageNameCh2))
            fullyImageNameCh3 = imagenameNoExtFullyCh3+'.'+self.fileExtension_under 
            fullpaths_file_fully.append(os.path.join(self.root_fully, subject, fullyImageNameCh3))
            fullyImageNameCh4 = imagenameNoExtFullyCh4+'.'+self.fileExtension_under 
            fullpaths_file_fully.append(os.path.join(self.root_fully, subject, fullyImageNameCh4))
            fullyImageNameCh5 = imagenameNoExtFullyCh5+'.'+self.fileExtension_under 
            fullpaths_file_fully.append(os.path.join(self.root_fully, subject, fullyImageNameCh5))
            fullyImageNameCh6 = imagenameNoExtFullyCh6+'.'+self.fileExtension_under 
            fullpaths_file_fully.append(os.path.join(self.root_fully, subject, fullyImageNameCh6))
