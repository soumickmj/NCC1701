...
class MRITorchDS(Dataset):
    ...
    def CreateImageBase(self, fullyContrast='PD', underContrast='T2', plane='axial', volNo = '1', onlyBrain=True):
        ...
        for folder in subfolders_fully:
            ...
            if(onlyBrain):
                ...
                fullpath_file_under = os.path.join(self.root_under, subject, undersampledImageName)
            else:
