...
def getARGSParser():
    ...
    parser.add_argument('--trainID', action="store", default="ResNet5_fullVol_L1Loss_lowmotion") ## "testing")  ## "ResNet14"
    ...
    parser.add_argument('--motion_degrees', action="store", default="1.0,3.0", help="Tuple of Float, passed as CSV")
    parser.add_argument('--motion_translation', action="store", default="1.0,3.0", help="Tuple of Float, passed as CSV")
    parser.add_argument('--motion_num_transforms', action="store", default="2,10", help="Tuple of Int, passed as CSV")
    parser.add_argument('--motion_num_ghosts', action="store", default="2,5", help="Tuple of Int, passed as CSV")
    parser.add_argument('--motion_intensity', action="store", default="0.01,0.75", help="Tuple of Float, passed as CSV")
