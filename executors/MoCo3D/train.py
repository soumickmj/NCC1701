...
def getARGSParser():
    ...
    parser.add_argument('--patch_size', action="store", default="96,96,28", help="length, width, depth")
    parser.add_argument('--input_shape', action="store", default="", help="length, width, depth (to be used if patch_size is not given)")
    parser.add_argument('--patch_qlen', action="store", default=100, type=int)  ## 5000 - 50
    parser.add_argument('--patch_per_vol', action="store", default=20, type=int)  # 1000 - 10
    parser.add_argument('--patch_inference_strides', action="store", default="32,32,32", help="stride_length, stride_width, stride_depth")
    ...
    parser.add_argument("-wnbg", "--wnbgroup", default='MixAll', help="WandB: Name of the group")
