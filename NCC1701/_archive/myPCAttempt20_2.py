...
IsResume = True
CheckpointPath = r"D:\Output\Attempt20-WithValidate-OASISVarden30SameMask-DenseResNetSSIMLoss-SingleSlice50\checkpoints\model_best.pth.tar"
...
netModel = importlib.import_module('model.DenseNet.DenseResNetWOdo').DenseResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt20-WithValidate-OASISVarden30SameMask-DenseResNetSSIMLoss-SingleSlice50'
