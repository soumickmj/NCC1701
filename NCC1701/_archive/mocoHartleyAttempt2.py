...
netModel = importlib.import_module('model.Wavelet.Praveen').CNNModel 
NetType = 0 # 0: ordinary, 1: KSPNet4FastMRI, 2: Super Res Net, 3: KSPNet
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt3-MoCoHartleyShepLog-CNNModel-SSIMLossInImg'
