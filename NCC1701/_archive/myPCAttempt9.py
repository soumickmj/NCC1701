...
IsResume = True
CheckpointPath = r'D:\Output\Attempt9-OASISVarden30SameMaskFourier-Resnet2Dv2-SingleSlice51\checkpoints\checkpoint.pth.tar'
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt9-OASISVarden30SameMaskFourier-Resnet2Dv2-SingleSlice51'
