...
###Resnet34	2DMultiSlice	No	200	neumann	12		OASIS-varden25	undersampled			
...
IsResume = True
CheckpointPath = r'Z:\Output\OASISVarden10\neumann\Attempt13-OASIS1Varden10-Resnet34-2DSelectMultiSlice65to72\checkpoints\checkpoint.pth.tar'
...
if(pc_name == 'intelnuc03'):
    ...
    train_entension_under = 'nii.gz'
    test_path_fully = r'Z:\Datasets\OASIS1\Undersampled-Registered\TestSet\varden101Vol'
    test_path_under = r'Z:\Datasets\OASIS1\Undersampled-Registered\TestSet\varden101Vol'
    test_entension_under = 'nii.gz'
    output_path = 'Z:\Output\OASISVarden10\neumann'
    output_folder = 'Attempt13-OASIS1Varden10-Resnet34-2DSelectMultiSlice65to72'
    output_path = os.path.join(output_path, output_folder)
elif(pc_name == 'quadro'):
    ...
    train_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Subset1/Registered-Undersampled/varden101Vol'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered'
    test_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered-Undersampled/varden101Vol'
    test_entension_under = 'nii.gz'
