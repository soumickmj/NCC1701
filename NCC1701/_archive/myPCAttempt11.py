...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-varden30SameMask-Slice51\ds1-fourier-train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-varden30SameMask-Slice51\ds1-fourier-test'
    ...
    output_folder = 'Attempt11-OASISVarden30SameMaskFourier-Resnet2Dv2L1Loss-SingleSlice51'
