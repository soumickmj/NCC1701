...
IsResume = True
CheckpointPath = r"D:\Output\Attempt20_2-WithValidate-OASISVarden30SameMask-DenseResNetDOSSIMLoss-SingleSlice50\checkpoints\model_best.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt20_2-WithValidate-OASISVarden30SameMask-DenseResNetDOSSIMLoss-SingleSlice50'
