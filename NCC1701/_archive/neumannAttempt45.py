...
IsResume = False
CheckpointPath = r"/scratch/tmp/schatter/Output/Neural/EnterpriseV1-gen2/Attempt40-WithValidate-Varden30SameMask-Resnet2Dv2SSIMLoss-51to80SingleEach/checkpoints/checkpoint.pth.tar"
...
netModel = importlib.import_module('model.ResNet.Resnet2Dv3b9').ResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt45-WithValidate-Varden30SameMask-Resnet2Dv2-9-SSIMLoss-51to80SingleEach'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
