...
dsClass = importlib.import_module('utils.TorchDS.IXI4SuperRes').MRITorchDS

#### Net Model Import path or object of the net model itself. 
netModel = importlib.import_module('model.ResNet.Resnet3Dv2b14_4').ResNet(n_channels=n_channels, input_shape=(130,256,256)) 
NetType = 2 # 0: ordinary, 1: KSPNet, 2: Super Res Net
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'E:\Datasets\IXI\IXI-DATA-SuperResolution'
    test_path_fully = r'E:\Datasets\IXI\IXI-DATA-SuperResolution' 
    val_path_fully = r'E:\Datasets\IXI\IXI-DATA-SuperResolution'
    ...
    output_path = r'D:\Output\Gen3\IXI-T2-SuRes\HH\3D'
    output_folder = 'Attempt0-IXIT2SuResHH-randomthick-Resnet3Dv2b14-SSIMLoss-3D'
...
if(run_mode == 0):
    train_set, _ = model.IntitializeMRITorchDS(dsClass, None, None, None, train_path_fully, None, None, n_workers_train, getROIRes, undersampling_mat, filename_filter_train, ds_split_xlsx_train, corupt_type, mask_func, mask_seed, top_n_sampled=top_n_sampled_train, ds_split2use='train')
    ...
    if val_path_fully is None: 
        _, train_setDS = model.IntitializeMRITorchDS(dsClass, None, None, None, train_path_fully, None, None, n_workers_train, getROIRes, undersampling_mat, filename_filter_train, ds_split_xlsx_train, corupt_type, mask_func, mask_seed, top_n_sampled=top_n_sampled_train, ds_split2use='train') 
        ...
        train_set, _ = model.IntitializeMRITorchDS(dsClass, None, None, None, train_path_fully, None, None, n_workers_train, getROIRes, undersampling_mat, filename_filter_train, ds_split_xlsx_train, corupt_type, mask_func, mask_seed, top_n_sampled=top_n_sampled_train, ds_split2use='train')
        val_set, _ = model.IntitializeMRITorchDS(dsClass, None, None, None, val_path_fully, None, None, n_workers_train, getROIRes, undersampling_mat, filename_filter_val, ds_split_xlsx_val, corupt_type, mask_func, mask_seed, top_n_sampled=top_n_sampled_train, ds_split2use='val')
    ...
    test_set, _ = model.IntitializeMRITorchDS(dsClass, None, None, None, test_path_fully, None, None, n_workers_test, getROIRes, undersampling_mat, filename_filter_test, ds_split_xlsx_test, corupt_type, mask_func, mask_seed, top_n_sampled=top_n_sampled_train, ds_split2use='test')
