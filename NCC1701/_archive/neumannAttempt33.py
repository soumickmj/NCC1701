...
###Resnet34	2DSingleSlice	No	200	neumann	30		OASIS-varden30new	undersampled			
...
neumann_names = ["c502.vc-a", "c503.vc-a"]
...
run_mode = 2 #0: Train 1: Train and Validate 2:Test 3: Train followed by Test
IsResume = True
CheckpointPath = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/Attempt33-OASISGauss30Same-ResnetSig-2DSingleSlice50/checkpoints/checkpoint.pth.tar'
...
netModel = importlib.import_module('model.GAN.Resnet2DSig').ResNet 
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Subset1/Registered-Undersampled/gauss30same'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered'
    test_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered-Undersampled/gauss30different'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt33_diff-OASISGauss30Same-ResnetSig-2DSingleSlice50'
    output_path = os.path.join(output_path, output_folder)
else:
