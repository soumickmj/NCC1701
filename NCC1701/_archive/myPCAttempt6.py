...
IsResume = True
CheckpointPath = r'D:\Output\Attempt6-OASISVarden30SameMaskFourier-Resnet2Dv1-SingleSlice50\checkpoints\checkpoint.pth.tar'
...
netModel = importlib.import_module('model.kSpace.ResNet.Resnet2Dv1').ResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt6-OASISVarden30SameMaskFourier-Resnet2Dv1-SingleSlice50'
