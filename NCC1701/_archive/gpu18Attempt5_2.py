...
netModel = ResNet(n_channels=n_channels, underDownStrategy='cropcenter', missingMask=missingMask)
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt5_2-Varden1D30SameMask-AdvResnet2Dv414L1Loss-fourier-slice51'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
