...
if __name__ == '__main__':
    ...
    test_name = 'WaveletImageCorrectNClassifyNet_Trainable_DO_BranchSplit_BothMSELoss'
    #in this net, branch split doesn't make sense. because if you split in this network, then the primary branch can only learn to correct the images and then the corrected wavelets will go into the secondary classify branch
    ...
    model = ImageCorrectNClassifyNet(n_class=1,trainable_wavelets=True, do_drop=True, branch_split=True)
    model.to(device)
