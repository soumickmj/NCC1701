...
from utils.TorchLoss.WeightedSSDLoss import WeightedSSDLoss
...
IsResume = False
CheckpointPath = r'D:\Output\Attempt27-WithValidate-Varden30SameMaskFourier-ResNet2Dv2WeightedSSDLoss-SingleSlice51\checkpoints\checkpoint.pth.tar'
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt27-WithValidate-Varden30SameMaskFourier-ResNet2Dv2WeightedSSDLoss-SingleSlice51'
