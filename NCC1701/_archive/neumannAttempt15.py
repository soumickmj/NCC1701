...
slicenoTrain = 49 #Only for 2DSingleSlice
slicenoTrain = slicenoTrain +1 #As array starts from 0
slicenoTest = 49 #Only for 2DSingleSlice
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Subset1/Registered-Undersampled/uniform20-X1vol'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered'
    test_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered-Undersampled/uniform20-X1vol'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt15-OASIS1Uniform20X-Resnet34-2SingleSlice50'
    output_path = os.path.join(output_path, output_folder)
else:
