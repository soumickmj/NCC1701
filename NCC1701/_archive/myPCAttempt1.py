...
IsResume = True
CheckpointPath = r'D:\Output\Attempt1-OASISVarden30SameMask-ResNeXt2D-d29w4s3-2SingleSlice50\checkpoints\checkpoint.pth.tar'
...
netModel = importlib.import_module('model.ResNeXt.ResNeXt2D').ResNeXt 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt1-OASISVarden30SameMask-ResNeXt2D-d29w4s3-2SingleSlice50'
