...
IsResume = False
CheckpointPath = r"D:\Output\Attempt33_2-WithValidate-Radial30GA_Fresh-Resnet2Dv2SSIMLoss-SingleSlice50\checkpoints\model_best.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Radial30GA-Slice50\ds1-image-train'
    ...
    output_folder = 'Attempt33_2_Redo-WithValidate-Radial30GA_Fresh-Resnet2Dv2SSIMLoss-SingleSlice50'
