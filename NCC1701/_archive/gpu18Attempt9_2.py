...
save_frequency = 1
IsResume = True
CheckpointPath = r"/raid/scratch/schatter/Output/Enterprise/v1-Gen2/Attempt9_2-Uniform28-4step-Resnet2Dv2b14XtremeV3-image-51to80SingleEach/checkpoints/checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt9_2-Uniform28-4step-Resnet2Dv2b14XtremeV3-image-51to80SingleEach'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
