...
maskORom_path = r"/home/schatter/Code/EnterpriseV1/Gen2/v4-20190618/1DUniformMask4step28per.mat"
maskORom_path = r"D:\CloudData\OneDrive\OvGU\My Codes\Neural\Enterprise\NCC1701\NCC1701\1DUniformMask4step28per.mat"
...
save_frequency = 1
IsResume = True
CheckpointPath = r"D:\Output\GPU18\andreas\Attempt12_2-Uniform28-4step-ImgKSPNet_Bottle64simple_Resnet2Dv2b14-image-51to80SingleEach\checkpoints\checkpoint.pth.tar"
...
netModel = ImgKSPNet(n_channels, ksp_bottle_neck_size=64, ksp_model_type='simplelinear')
IsImgKSPNet = True
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden1D30SameMask-51to80SingleEach\ds1-image-train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden1D30SameMask-51to80SingleEach\ds1-image-test'
    test_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TestSet\varden30SameMask'
    test_entension_under = 'nii.gz'
    output_path = r'D:\Rough'
    ...
    tb_logroot = '/raid/scratch/schatter/Output/TensorBoardLogs'
    train_path_fully = '/raid/scratch/schatter/Dataset/MATs/OASIS-Subset1-Uniform28-4step-51to80SingleEach/ds1-image-train'
    train_path_under = '/raid/scratch/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/raid/scratch/schatter/Dataset/MATs/OASIS-Subset1-Uniform28-4step-51to80SingleEach/ds1-image-test'
    test_path_under = '/raid/scratch/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Test'
    test_entension_under = 'nii.gz'
    output_path = '/raid/scratch/schatter/Output/Enterprise/v1-Gen2'
    output_folder = 'Attempt12_2-Uniform28-4step-ImgKSPNet_Bottle64simple_Resnet2Dv2b14-image-51to80SingleEach'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
