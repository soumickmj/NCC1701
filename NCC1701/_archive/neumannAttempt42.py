...
IsResume = True
CheckpointPath = r"/scratch/tmp/schatter/Output/Neural/EnterpriseV1-gen2/Attempt42-WithValidate-CombinedBest2-Resnet2Dv2SSIMLoss-51to80SingleEach/checkpoints/checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = '/scratch/tmp/schatter/Datasets/MATs/20190320Fresh_Correct/OASIS-CombinedBest2-51to80SingleEach/ds1-image-train'
    train_path_under = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/MATs/20190320Fresh_Correct/OASIS-Subset1-Radial60GA-51to80SingleEach/ds1-image-test'
    test_path_under = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Test'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1-gen2/'
    output_folder = 'Attempt42-WithValidate-CombinedBest2-Resnet2Dv2SSIMLoss-51to80SingleEach'
