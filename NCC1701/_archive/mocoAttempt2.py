...
save_frequency = 1
IsResume = False
CheckpointPath = r"D:\Output\Gen3\IXI-T1-MoCo\Guys\Attempt1-IXIT1MoCoGuys-Rot25-tx0ty0-CInvUNet-KLDLoss-Slice60to90\checkpoints\checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt2-IXIT1MoCoGuys-Rot25-tx0ty0-CInvUNet-KLDLossForReal-Slice60to90'
