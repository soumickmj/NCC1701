...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt6-IXIT2SuResHH-interpolated-randomthick-Resnet3Dv2b10start16-MSELoss-3D'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
elif(pc_name == 'brain'):
    ##For GPU18 Cluster - For Undersampled Images
    ...
    output_folder = 'Attempt6-IXIT2SuResHH-interpolated-randomthick-Resnet3Dv2b10start16-MultiSSIMLoss-3D'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
