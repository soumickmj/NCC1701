...
IsResume = True
CheckpointPath = r"/home/soumick/Output/Neural/EnterpriseV1-gen2/Attempt23_Redo-WithValidate-AllCombined4-Resnet2Dv2SSIMLoss-51to80SingleEach/checkpoints/checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_path = os.path.join(output_path, output_folder, 'Radial30GA')
    tb_logpath = os.path.join(tb_logroot, output_folder)
...
ApplyDataConsis(output_path, True, True, r'/home/soumick/Dokumente/Projects/EnterpriseNeural/Gen2/v1-20190323/Radial30spGA.mat')
