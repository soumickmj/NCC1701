...
#netModel = importlib.import_module('model.kSpace.ResNet.AdvResnet2Dv1').ResNet 
from model.kSpace.ResNet.AdvResnet2Dv1 import ResNet
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt2_4-Varden1D30SameMask-AdvResnet2Dv114L1Loss-fourier-slice51'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
