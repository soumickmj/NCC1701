...
IsResume = True
CheckpointPath = r'D:\Output\Attempt16_3-WithValidate-OASISVarden30SameMask-Resnet2Dv2-SingleSlice51\checkpoints\checkpoint.pth.tar'
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-Radial30-Slice50\ds1-image-train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-Radial30-Slice50\ds1-image-test'
    ...
    output_folder = 'Attempt21-WithValidate-OASISRadial30-ResNet2Dv2SSIMLoss-SingleSlice50'
