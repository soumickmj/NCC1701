...
save_frequency = 1
IsResume = True
CheckpointPath = r"D:\Output\Gen3\fastMRI\Brain\AllSlices\Attempt0-fastMRIBrain-AccFact4Center08-SoltantoRes40-SSIMImgLoss-AllSlices\checkpoints\checkpoint.pth.tar"
...
netModel = importlib.import_module('model.kSpace.SoltantoRes').ResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt0-fastMRIBrain-AccFact4Center08-SoltantoRes40-SSIMImgLoss-AllSlices'
