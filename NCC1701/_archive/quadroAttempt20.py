...
IsResume = True
CheckpointPath = r"/home/soumick/Output/Neural/EnterpriseV1-gen2/Attempt20_Redo-WithValidate-Radial60GA-Resnet2Dv2SSIMLoss-51to80SingleEach/checkpoints/checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = '/home/soumick/Datasets/Datasets/MATs/20190320Fresh_Correct/OASIS-Subset1-Radial60GA-51to80SingleEach/ds1-image-train'
    ...
    output_folder = 'Attempt20_Redo-WithValidate-Radial60GA-Resnet2Dv2SSIMLoss-51to80SingleEach'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
