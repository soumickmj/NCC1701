...
IsResume = True
CheckpointPath = r"D:\Output\Attempt31_2-WithValidate-Uniform28-4step_Fresh-Resnet2Dv2SSIMLoss-SingleSlice50\checkpoints\model_best.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Uniform28-4step-Slice50\ds1-image-train'
    ...
    output_folder = 'Attempt31_2-WithValidate-Uniform28-4step_Fresh-Resnet2Dv2SSIMLoss-SingleSlice50'
    output_path = os.path.join(output_path, output_folder, 'best')
