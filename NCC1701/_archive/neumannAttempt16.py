...
###Resnet34	2SingleSlice	No	200	neumann	15	OASIS-uniformX20	undersampled
...
IsResume = True
CheckpointPath = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/Attempt16-AbdomenBenz07to12Low2High-Unetv2-2SingleSlice50/checkpoints/checkpoint.pth.tar'
...
lrDecayNEpoch = 250 #4 #Decay the learning rate after every 4th epoch
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_fully = '/scratch/tmp/schatter/Datasets/AbdomenBenz/woROI/50center/12'
    train_path_under = '/scratch/tmp/schatter/Datasets/AbdomenBenz/woROI/50center/07'
    train_entension_under = 'nii'
    test_path_fully = '/scratch/tmp/schatter/Datasets/AbdomenBenz/woROI/HR/woROI/12'
    test_path_under = '/scratch/tmp/schatter/Datasets/AbdomenBenz/woROI/HR/woROI/07'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt17-AbdomenBenz07to12Low2High-Unetv2-2SingleSlice50'
    output_path = os.path.join(output_path, output_folder)
else:
