...
###Resnet34	2DSingleFourier	No	200	neumann	17		OASIS-Uniform28	Undersampled
...
IsResume = True
CheckpointPath = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/Attempt18-OASISUniform28X-Resnetv2-2SingleSlice50/checkpoints/checkpoint.pth.tar'
...
netModel = importlib.import_module('model.GAN.Resnet2Dv2').ResNet 
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Subset1/Registered-Undersampled/uniform1d28per-X'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered'
    test_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered-Undersampled/uniform1d28per-X'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt18-OASISUniform28X-Resnetv2-2SingleSlice50'
    output_path = os.path.join(output_path, output_folder)
else:
