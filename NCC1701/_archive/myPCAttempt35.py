...
IsResume = True
CheckpointPath = r"D:\Output\Attempt35_Redo-WithValidate-OASIS-AllCombined4_Fresh-Resnet2Dv2SSIMLoss-SingleSlice50\checkpoints\checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-AllCombined4-Slice50\ds1-image-train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    #test_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Radial30GA-Slice50\ds1-image-test'
    #test_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Radial60GA-Slice50\ds1-image-test'
    #test_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden30SameMask-Slice50\ds1-image-test'
    test_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Uniform28-4step-Slice50\ds1-image-test'
    ...
    output_folder = 'Attempt35_Redo-WithValidate-OASIS-AllCombined4_Fresh-Resnet2Dv2SSIMLoss-SingleSlice50'
    output_path = os.path.join(output_path, output_folder,'Uniform28-4step')
