...
save_frequency = 1
IsResume = True
CheckpointPath = r"D:\Output\Gen3\fastMRI\Skyra\AllSlices\Attempt1-fastMRISkyra-AccFact4Center08-CUNet-MSELoss-AllSlices\checkpoints\checkpoint61.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt1-fastMRISkyra-AccFact4Center08-CUNet-MSELoss-AllSlices-Ep61'
