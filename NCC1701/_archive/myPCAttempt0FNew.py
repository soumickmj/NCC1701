...
if(pc_name == 'BMMR-Soumick'):
    ...
    ##For BMMR-Soumick - For Undersampled Images
    train_path_fully = r'D:\Output\Attempt0X-GenMAT'
    train_path_under = r'D:\Output\Attempt0X-GenMAT'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Output\Attempt0X-GenMAT'
    test_path_under = r'D:\Output\Attempt0X-GenMAT'
    test_entension_under = 'nii.gz'
    output_path = r'D:\Output'
    output_folder = 'Attempt0-TestFMAT'
    output_path = os.path.join(output_path, output_folder)
