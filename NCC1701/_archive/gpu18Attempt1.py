...
#mat_contents = sio.loadmat(r"/home/schatter/Code/EnterpriseV1/Gen2/v2-20190514/1DVarden30Mask.mat")
...
netModel = ImgKSPNet(n_channels, ksp_bottle_neck_size=2, ksp_model_type='simplelinear', multilossreturn=True)
IsImgKSPNet = True
...
pinMemory = False
loss_func = ImgSSIMFromFourierLoss
...
if(pc_name == 'BMMR-Soumick'):
    ...
    tb_logroot = r'D:\Rough'
    train_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden1D30SameMask-Slice50\ds1-image-train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden1D30SameMask-Slice50\ds1-image-test'
    ...
    tb_logroot = '/home/schatter/Output/TensorBoardLogs'
    train_path_fully = '/home/schatter/Dataset/MATs/OASIS-Subset1-Varden1D30SameMask-Slice51/ds1-fourier-train'
    train_path_under = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/home/schatter/Dataset/MATs/OASIS-Subset1-Varden1D30SameMask-Slice51/ds1-fourier-test'
    test_path_under = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Test'
    test_entension_under = 'nii.gz'
    output_path = '/home/schatter/Output/Enterprise/v1-Gen2'
    output_folder = 'Attempt1-Varden1D30SameMask-AdvResnet2D14ImgSSIMFromFLoss-fourier-slice51'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
...
ApplyDataConsis(output_path, False, True, r'/home/schatter/Code/EnterpriseV1/Gen2/v2-20190514/1DVarden30Mask.mat')
