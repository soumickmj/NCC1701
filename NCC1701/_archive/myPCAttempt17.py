...
IsResume = True
CheckpointPath = r"D:\Output\Attempt17-WithValidate-OASISVarden30SameMask-DenseResNet-SingleSlice50\checkpoints\model_best.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt17-WithValidate-OASISVarden30SameMask-DenseResNet-SingleSlice50'
