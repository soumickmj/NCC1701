...
#### Basic parameters
domain = 'hartley' #In which domain, network should work? Acceptable values: | fourier | real_fourier | abs_of_fourier | real_of_fourier | abs_of_real_fourier | real_of_real_fourier | hartley | image |
...
IsResume = False
CheckpointPath = r'D:\Output\Attempt7-OASISVarden30SameMaskFourier-Resnet2Dv2-SingleSlice51\checkpoints\checkpoint.pth.tar'
...
netModel = importlib.import_module('model.kSpace.ResNet.Resnet2Dv2').ResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-varden30SameMask-Slice51\ds3-hartley-train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-varden30SameMask-Slice51\ds3-hartley-test'
    ...
    output_folder = 'Attempt13_2-OASISVarden30SameMaskHartley-Resnet2Dv2L1Loss-SingleSlice51'
...
model = Model(domain, batch_size, type = modelType, pin_memory = pinMemory, undersamplingMask = mask)
if IsGAN:
...
if(run_mode == 0):
    ...
    _, train_setDS = model.IntitializeMRITorchDS(dsClass, slicenoTrain, startingSelectSlice, endingSelectSlice, train_path_fully, train_path_under, train_entension_under, n_workers_train, getROIMode, mask) #TODO , sliceno = slicenoTrain
