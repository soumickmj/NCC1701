...
if(pc_name == 'intelnuc03'):
    ...
    output_folder = 'QuadroAttempt5-ImageT1T2-Unet2Dv2-2DMulti'
    output_path = os.path.join(output_path, output_folder)
    ...
    #output_folder = 'Attempt10-GAN-Unetmario-Dis2Dv2'

    #For Mario's PC - Undersampled
    train_path_fully = r'D:\OASIS1\Registered\TrainSet'
    train_path_under = r'D:\OASIS1\Undersampled-Registered\TrainSet\varden30'
    train_entension_under = 'nii'
    test_path_fully = r'D:\OASIS1\Registered\TestSet'
    test_path_under = r'D:\OASIS1\Undersampled-Registered\TestSet\varden30'
    test_entension_under = 'nii'
    output_path = 'D:\Soumick\Output\OASIS1Varden30'
    output_folder = 'Attempt5-CycleGAN-UNet2Dv2-Dis2Dv2'
    output_path = os.path.join(output_path, output_folder)
elif(pc_name == 'quadro'):
    ...
    #output_folder = 'Attempt6-ImageT1T2-CycleGANv1-2DSingle'
    #output_path = os.path.join(output_path, output_folder)
    ...
    test_entension_under = 'nii'
    output_path = '/home/soumick/Output/Neural/EnterpriseV1/Undersampled/'
    output_folder = 'Attempt1-CycleGAN-UNet2Dv2-Dis2Dv2'
    output_path = os.path.join(output_path, output_folder)
else:
