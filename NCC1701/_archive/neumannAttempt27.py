...
###UnetPaper	2DSingleSlice	No	200	25		OASIS-varden30-samemask	undersampled			
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Subset1/Registered-Undersampled/varden302dimSameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered'
    test_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered-Undersampled/varden302dimSameMask'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt27-OASISVarden302dimSameMask-Resnet-2SingleSlice50'
    output_path = os.path.join(output_path, output_folder)
else:
