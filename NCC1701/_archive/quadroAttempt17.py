...
###Resnet34	3D59to74	No	200	quadro	17		OASIS-varden25	undersampled			
...
startingSelectSlice = 59 #Only for 2DSelectMultiSlice and 3DSelectSlice
startingSelectSlice = startingSelectSlice - 1 #As array starts from 0
endingSelectSlice = 74 #Only for 2DSelectMultiSlice and 3DSelectSlice
modelType = '3DSelectSlice' #Type of Model, it can be 3D, 2DMultiSlice, 2DSingleSlice, 2D, 2DSelectMultiSlice, 3DSelectSlice
IsGAN = False
...
netModel = importlib.import_module('model.GAN.Resnet3D').ResNet 
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_under = '/home/soumick/Datasets/Datasets/OASIS1/TrainSet1/Registered-Undersampled/varden25'
    train_entension_under = 'nii.gz'
    test_path_fully = '/home/soumick/Datasets/Datasets/OASIS1/TestSet1/Registered'
    test_path_under = '/home/soumick/Datasets/Datasets/OASIS1/TestSet1/Registered-Undersampled/varden25'
    test_entension_under = 'nii.gz'
    output_path = '/home/soumick/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt17-OASIS1Varden25-Resnet3D-3DSelectSlice59to74'
    output_path = os.path.join(output_path, output_folder)
    ...
    train_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Subset1/Registered-Undersampled/Varden25'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered'
    test_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered-Undersampled/Varden25'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt12_2-OASIS1Varden25Real-Resnet34-2DSelectMultiSlice65to72'
    output_path = os.path.join(output_path, output_folder)
else:
