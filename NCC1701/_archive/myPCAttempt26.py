...
from utils.TorchLoss.ImgSSIMFourierSSDLoss import ImgSSIMFourierSSDLoss
...
pinMemory = False
loss_func = ImgSSIMFourierSSDLoss
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt26-WithValidate-Varden30SameMaskFourier-ResNet2Dv2ImgSSIMFourierSSDLoss-SingleSlice51'
