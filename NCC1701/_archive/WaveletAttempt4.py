...
netModel = importlib.import_module('model.Wavelet.Praveen').Praveen(trainable_wavelets=True, do_drop=True) 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt4-OASISSubset1-Varden2D30-Resnet2Dv2b14WaveletTrainableDrop50ev2-SSIMLoss-Slice50'
