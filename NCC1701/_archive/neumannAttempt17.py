...
IsResume = True
CheckpointPath = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/Attempt17-OASISUniform28X-Resnet-2SingleSlice50/checkpoints/checkpoint.pth.tar'
...
if(pc_name == 'intelnuc03'):
    ...
    output_folder = 'Attempt17-OASISUniform28X-Resnet-2SingleSlice50'
    output_path = os.path.join(output_path, output_folder)
else:
