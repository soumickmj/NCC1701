...
netModel = importlib.import_module('model.ResNet.Resnet3Dv2b14_2').ResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt7-IXIT2SuResHH-interpolated-randomthick-Resnet3Dv2b10start16_2-MSELoss-3D'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
elif(pc_name == 'brain'):
    ##For GPU18 Cluster - For Undersampled Images
    ...
    output_folder = 'Attempt7-IXIT2SuResHH-interpolated-randomthick-Resnet3Dv2b10start16_2-MultiSSIMLoss-3D'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
