...
save_frequency = 1
IsResume = False
CheckpointPath = r"D:\Output\Gen3\IXI-T1-MoCo\Guys\Attempt4-IXIT1MoCoGuys-Rot25-tx0ty0-CInvUNetResNetv214-MSELossImg-Slice60to90\checkpoints\checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'E:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden1D30SameMask-Slice50\ds1-image-train'
    test_path_fully = r'E:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden1D30SameMask-Slice50\ds1-image-test' 
    val_path_fully = r'E:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden1D30SameMask-Slice50\ds1-image-test'
    ds_split_xlsx_train = None
    ds_split_xlsx_test = None
    ds_split_xlsx_val = None
    output_path = r'D:\Output\Gen3\OASIS1'
    output_folder = 'Attempt2_3-OASISSubset1-Varden1D30-Resnet2Dv2b14WaveletTrainable-SSIMLoss-Slice50'
