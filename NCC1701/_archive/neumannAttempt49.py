...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = '/scratch/tmp/schatter/Datasets/MATs/20190320Fresh/OASIS-Subset1-Varden2D30SameMask-51to80SingleEach/ds1-image-train'
    train_path_under = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/MATs/20190320Fresh/OASIS-Subset1-Varden2D30SameMask-51to80SingleEach/ds1-image-test'
    test_path_under = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Test'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1-gen2/'
    output_folder = 'Attempt49-WithValidate-Varden2D30SameMask-Resnet2Dv2SSIMLoss-51to80SingleEach'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
...
ApplyDataConsis(output_path, False, True, r'/scratch/tmp/schatter/Code/EnterpriseV1/Gen2/v1-20190322/2DVarden30Mask.mat')
