...
IsResume = True
CheckpointPath = r"/scratch/tmp/schatter/Output/Neural/EnterpriseV1-gen2/Attempt39-WithValidate-CombinedBest2-Resnet2Dv2SSIMLoss-Slice50/checkpoints/checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt39-WithValidate-CombinedBest2-Resnet2Dv2SSIMLoss-Slice50'
