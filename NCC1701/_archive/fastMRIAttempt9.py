...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt1-fastMRIBrain-AccFact4Center08-Resnet2Dv2b1413-SSIMImgLoss-AllSlices'
    ...
    output_folder = 'XAttempt0-fastMRIBrain-AccFact4Center08-Resnet2Dv2b1413-SSIMImgLoss-AllSlices'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
