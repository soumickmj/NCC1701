...
IsResume = False
CheckpointPath = r'D:\Output\Attempt8-OASISVarden30SameMaskFourier-Resnet2Dv1-SingleSlice51\checkpoints\checkpoint.pth.tar'
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt8-OASISVarden30SameMaskFourier-Resnet2Dv1-SingleSlice51'
