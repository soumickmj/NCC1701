...
if IsGAN:
    ...
    Model = importlib.import_module('model.ModelMSSSIML1Loss').Model 
...
initialLearningRateD = 0.1
lrDecayNEpochD = 4 #Decay the learning rate after every 4th epoch
lrDecayRateD = 0.5 #Decay by half
beta1D = 0.9 #Momentum parameter of the gradients
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_fully = r'D:\Datasets\AlexMultiCon\Train\T1-ROI'
    train_path_under = r'D:\Datasets\AlexMultiCon\Train\T2'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\AlexMultiCon\Test\T1-ROI'
    test_path_under = r'D:\Datasets\AlexMultiCon\Test\T2'
    test_entension_under = 'nii.gz'
    output_path = 'D:\Output\AlexT1T2'
    output_folder = 'RoughAttempt'
    output_path = os.path.join(output_path, output_folder)
elif(pc_name == 'powerzon04'):
    #For Mario's PC - For Contrast Translation
    train_path_fully = r'Z:\Datasets\AlexMultiCon2\IXI-Dataset\T1\Guys-Train'
    train_path_under = r'Z:\Datasets\AlexMultiCon2\IXI-Dataset\T2\Guys-Train'
    train_entension_under = 'nii.gz'
    test_path_fully = r'Z:\Datasets\AlexMultiCon2\IXI-Dataset\T1\Guys-Test'
    test_path_under = r'Z:\Datasets\AlexMultiCon2\IXI-Dataset\T2\Guys-Test'
    test_entension_under = 'nii.gz'
    output_path = 'Z:\Output\AlexT1T2-New'
    output_folder = 'Attempt3-ImageUnseenT2T1-Unet2Dv2'
    output_path = os.path.join(output_path, output_folder)
elif(pc_name == 'quadro'):
    ...
    output_folder = 'Attempt2-ImageT1T2-Unet2Dv2-msssiml1loss'
    output_path = os.path.join(output_path, output_folder)
else:
...
if(run_mode == 0):
    train_set, _ = model.IntitializeMRITorchDS(dsClass, train_path_fully, train_path_under, train_entension_under, n_workers_train, getROIMode)
    ...
    _, train_setDS = model.IntitializeMRITorchDS(dsClass, train_path_fully, train_path_under, train_entension_under, n_workers_train, getROIMode) #TODO , sliceno = slicenoTrain
    ...
    test_set, _ = model.IntitializeMRITorchDS(dsClass, test_path_fully, test_path_under, test_entension_under, n_workers_test, getROIMode)
