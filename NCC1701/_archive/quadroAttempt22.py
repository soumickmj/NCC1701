...
mat_contents = sio.loadmat(r"/home/soumick/Dokumente/Projects/EnterpriseNeural/Gen2/v1-20190323/1DVardenMask.mat")
...
IsResume = True
CheckpointPath = r"/home/soumick/Output/Neural/EnterpriseV1-gen2/Attempt22_Redo-WithValidate-CombinedBest2-Resnet2Dv2SSIMLoss-51to80SingleEach/checkpoints/checkpoint.pth.tar"
...
netModel = importlib.import_module('model.ResNet.Resnet2Dv2').ResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    tb_logroot = r'/home/soumick/Output/Neural/TensorBoardLogs'
    train_path_fully = '/home/soumick/Datasets/Datasets/MATs/20190320Fresh_Correct/OASIS-CombinedBest2-51to80SingleEach/ds1-image-train'
    train_path_under = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/home/soumick/Datasets/Datasets/MATs/20190320Fresh_Correct/OASIS-Subset1-Radial60GA-51to80SingleEach/ds1-image-test'
    ...
    output_folder = 'Attempt22_Redo-WithValidate-CombinedBest2-Resnet2Dv2SSIMLoss-51to80SingleEach'
    output_path = os.path.join(output_path, output_folder, 'Radial60GA')
    tb_logpath = os.path.join(tb_logroot, output_folder)
...
ApplyDataConsis(output_path, True, True, r'/scratch/tmp/schatter/Code/EnterpriseV1/Gen2/v1-20190322/Radial60spGA.mat')
