...
###Resnet34	2DSingleSlice	Yes, Cycle	200	quadro			Alex2	T1-T2
...
dsClass = importlib.import_module('utils.TorchDS.AlexDS2_NoMask').MRITorchDS #For Alex's 6 Channel DS
...
decay_start_epoch = 100 #For CycleGAN
...
if(pc_name == 'intelnuc03'):
    ...
    output_folder = 'Attempt11-ImageT1T2-Resnet34CycleGANDiscv2-2DSingle'
    output_path = os.path.join(output_path, output_folder)
    ...
    output_folder = 'Attempt1-Varden30-Unet2Dv2-2DSingle'
    output_path = os.path.join(output_path, output_folder)
else:
