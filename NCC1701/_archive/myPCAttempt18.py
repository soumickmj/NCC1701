...
IsResume = True
CheckpointPath = r"D:\Output\Attempt18-WithValidate-OASISVarden30SameMask-ResNet2Dv2-SingleSlice50\checkpoints\model_best.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt18-WithValidate-OASISVarden30SameMask-ResNet2Dv2-SingleSlice50'
