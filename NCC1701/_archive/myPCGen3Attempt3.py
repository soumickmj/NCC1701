...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'E:\Datasets\IXI\MATs\IXI-T1\Guys\Slice60to90\Varden1D10SameMask\train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'E:\Datasets\IXI\MATs\IXI-T1\Guys\Slice60to90\Varden1D10SameMask\test'
    test_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TestSet\varden30SameMask'
    test_entension_under = 'nii.gz'
    val_path_fully = r'E:\Datasets\IXI\MATs\IXI-T1\Guys\Slice60to90\Varden1D10SameMask\val'
    ...
    output_folder = 'Attempt3-IXIT1GuysVarden1D10-Resnet2Dv214PReLU-SSIMLoss-Slice60to90'
    ...
    train_path_fully = r'/nfs1/schatter/IXI/MATs/IXI-T1/HH/AllSlices/Radial60spGA/train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'/nfs1/schatter/IXI/MATs/IXI-T1/HH/AllSlices/Radial60spGA/test'
    test_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TestSet\varden30SameMask'
    test_entension_under = 'nii.gz'
    val_path_fully = r'/nfs1/schatter/IXI/MATs/IXI-T1/HH/AllSlices/Radial60spGA/val'
    val_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TestSet\varden30SameMask'
    val_entension_under = 'nii.gz'
    output_path = r'/raid/scratch/schatter/Output/Enterprise/v1-Gen3/IXI-T1/HH/AllSlices'
    output_folder = 'Attempt9-IXIT1HHRadial60-Resnet2Dv214PReLU-SSIMLoss-AllSlices'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
