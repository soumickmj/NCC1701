...
from utils.TorchLoss.ImgSSIMHartleySSDLoss import ImgSSIMHartleySSDLoss
...
IsResume = False
CheckpointPath = r'D:\Output\Attempt26-WithValidate-Varden30SameMaskFourier-ResNet2Dv2ImgSSIMFourierSSDLoss-SingleSlice51\checkpoints\model_best.pth.tar'
...
pinMemory = False
loss_func = ImgSSIMHartleySSDLoss
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt28-WithValidate-Varden30SameMaskHartley-ResNet2Dv2ImgSSIMFourierSSDLoss-SingleSlice51'
