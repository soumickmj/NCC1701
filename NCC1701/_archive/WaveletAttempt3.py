...
netModel = importlib.import_module('model.Wavelet.Praveen').Praveen(do_drop=True) 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt3-OASISSubset1-Varden2D30-Resnet2Dv2b14WaveletDrop50ev2-SSIMLoss-Slice50'
