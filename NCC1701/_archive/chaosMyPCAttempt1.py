...
IsResume = False
CheckpointPath = r'D:\Output\Attempt4-OASISVarden30SameMask-Densenet2D-d100g12r50-2SingleSlice50\checkpoints\checkpoint.pth.tar'
...
netModel = importlib.import_module('model.ResNet.Resnet3DSeg').ResNet 
#netModel = importlib.import_module('model.DenseNet.DenseUNet2D').DenseUNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\CHAOS_MRI\AllSequenceSeperate'
    ...
    output_folder = 'CHAOSAttempt1-Resnet3D34Seg'
