...
###UnetPaper	2DSingleSlice	No	2000	18		OASIS-varden30	undersampled			
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_under = '/home/soumick/Datasets/Datasets/OASIS1/TrainSet1/Registered-Undersampled/Varden30'
    train_entension_under = 'nii'
    test_path_fully = '/home/soumick/Datasets/Datasets/OASIS1/TestSet1/Registered'
    test_path_under = '/home/soumick/Datasets/Datasets/OASIS1/TestSet1/Registered-Undersampled/Varden30'
    test_entension_under = 'nii'
    output_path = '/home/soumick/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt18-OASISVarden30-UnetMRIPaperOriginalParam-2DSingleSlice50'
    output_path = os.path.join(output_path, output_folder)
    ...
    train_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Subset1/Registered-Undersampled/Varden30'
    train_entension_under = 'nii'
    test_path_fully = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered'
    test_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered-Undersampled/Varden30'
    test_entension_under = 'nii'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt26-OASISVarden30-UnetMRIPaperOriginalParam-2DSingleSlice50'
    output_path = os.path.join(output_path, output_folder)
else:
