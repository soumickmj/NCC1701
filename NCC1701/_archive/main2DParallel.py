...
modelType = '2DMultiSlice' #Type of Model, it can be 3D, 2DMultiSlice, 2DSingleSlice, 2D
IsGAN = False
...
netModel = importlib.import_module('model.UNet.Unet2Dv2Parallel').UNet 
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_fully = r'D:\Soumick\AlexMultiCon2\IXI-Dataset\MRA\Guys-Train'
    train_path_under = r'D:\Soumick\AlexMultiCon2\IXI-Dataset\T1\Guys-Train'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Soumick\AlexMultiCon2\IXI-Dataset\MRA\Guys-Test'
    test_path_under = r'D:\Soumick\AlexMultiCon2\IXI-Dataset\T1\Guys-Test'
    test_entension_under = 'nii.gz'
    output_path = 'D:\Soumick\Output\AlexT1T2-New'
    output_folder = 'Attempt5-ImageUnseenT1MRA-Unet2Dv2'
    output_path = os.path.join(output_path, output_folder)
elif(pc_name == 'quadro'):
    ...
    output_folder = 'Attempt4-ImageT1T2-Unet2Dv2-2DParallel'
    output_path = os.path.join(output_path, output_folder)
else:
