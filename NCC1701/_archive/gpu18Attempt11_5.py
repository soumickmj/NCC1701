...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = '/raid/scratch/schatter/Dataset/MATs/OASIS-AllCombined4-51to80SingleEach/ds1-image-train'
    ...
    output_folder = 'Attempt11_5-AllCombined4-Resnet2Dv2b14XtremeSupreme-image-51to80SingleEach'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
