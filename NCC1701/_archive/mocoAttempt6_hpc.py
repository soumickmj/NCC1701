...
save_frequency = 1
IsResume = True
CheckpointPath = r"/mnt/beegfs/vc-a/tmp/schatter/Output/Gen3/IXI-T1-MoCo/HH/Attempt6-IXIT1MoCoHH-RotMax25-tx0ty0-Resnet2Dv2b14-SSIMLoss-Slice60to90/checkpoints/checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt6-IXIT1MoCoGuys-RotMax25-tx0ty0-Resnet2Dv2b14-SSIMLoss-Slice60to90'
    ...
    output_folder = 'Attempt6-IXIT1MoCoHH-RotMax25-tx0ty0-Resnet2Dv2b14-SSIMLoss-Slice60to90'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
