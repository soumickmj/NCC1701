...
netModel = importlib.import_module('model.ResNet.Resnet3Dv2b14').ResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_under = r'/nfs1/schatter/IXI/IXI-T1/Under/1DVarden15Mask'
    test_path_fully = r'/nfs1/schatter/IXI/IXI-T1/Fully' 
    test_path_under = r'/nfs1/schatter/IXI/IXI-T1/Under/1DVarden15Mask' 
    val_path_fully = r'/nfs1/schatter/IXI/IXI-T1/Fully'
    val_path_under = r'/nfs1/schatter/IXI/IXI-T1/Under/1DVarden15Mask'
    ...
    output_folder = 'Attempt1-IXIT1HH-1DVarden15Mask-Resnet3Dv2b14start32-MultiSSIMSum-3D'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
elif(pc_name == 'brain'):
    ##For GPU18 Cluster - For Undersampled Images
