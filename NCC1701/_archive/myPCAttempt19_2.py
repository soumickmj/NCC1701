...
IsResume = True
CheckpointPath = r"D:\Output\Attempt19_2-WithValidate-OASISVarden30SameMask-ResNet2Dv2SSIMLossAdaBoundOptim-SingleSlice50\checkpoints\model_best.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-varden30SameMask-Slice50\ds1-image-train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-varden30SameMask-Slice50\ds1-image-test'
    ...
    output_folder = 'Attempt19_2-WithValidate-OASISVarden30SameMask-ResNet2Dv2SSIMLossAdaBoundOptim-SingleSlice50'
