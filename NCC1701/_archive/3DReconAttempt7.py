...
#### Basic parameters
domain = 'image' #In which domain, network should work? Acceptable values: | fourier | hartley | image | compleximage |
n_coils = 1
...
filename_filter_train = ['HH'] #['Aera','Biograph_mMR','Prisma_fit', 'Skyra']
filename_filter_test = ['HH'] #['Aera','Biograph_mMR','Prisma_fit', 'Skyra']
filename_filter_val = ['HH'] #['Aera','Biograph_mMR','Prisma_fit', 'Skyra']
...
modelType = '3D' #Type of Model, it can be 3D, 2DMultiSlice, 2DSingleSlice, 2D, 2DSelectMultiSlice, 3DSelectSlice
modelType_actual = '3D'
IsRadial = False
...
save_frequency = 1
IsResume = True
CheckpointPath = r'/nfs1/schatter/Output/Enterprise/v1-Gen3/IXI-T1/HH/3D/Attempt7-IXIT1HH-1DVarden30Mask-Resnet3Dv2b_4_14start32_updown2-MultiSSIMLoss-3D/checkpoints/checkpoint.pth.tar'
...
dsClass = importlib.import_module('utils.TorchDS.IXI').MRITorchDS

#### Net Model Import path or object of the net model itself. 
netModel = importlib.import_module('model.ResNet.Resnet3Dv2b14_4').ResNet 
NetType = 0 # 0: ordinary, 1: KSPNet, 2: Super Res Net
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'E:\Datasets\IXI\IXI-T1'
    train_path_under = r'E:\Datasets\IXI\Under\IXI-T1\1DVarden15Mask'
    test_path_fully = r'E:\Datasets\IXI\IXI-T1'
    test_path_under = r'E:\Datasets\IXI\Under\IXI-T1\1DVarden15Mask'
    val_path_fully = r'E:\Datasets\IXI\IXI-T1'
    val_path_under = r'E:\Datasets\IXI\Under\IXI-T1\1DVarden15Mask'
    ds_split_xlsx_train = r"E:\Datasets\IXI\hh_split.xlsx"
    ds_split_xlsx_test = r"E:\Datasets\IXI\hh_split.xlsx"
    ds_split_xlsx_val = r"E:\Datasets\IXI\hh_split.xlsx"
    output_path = r'D:\Output\Gen3\IXI-T1\HH\3D'
    output_folder = 'Attempt0-IXIT1HH-1DVarden15Mask-Resnet3Dv2b10start16-MultiSSIMSum-3D'
    ...
    train_path_fully = r'/nfs1/schatter/IXI/IXI-T1/Fully'
    train_path_under = r'/nfs1/schatter/IXI/IXI-T1/Under/1DVarden30Mask'
    test_path_fully = r'/nfs1/schatter/IXI/IXI-T1/Fully' 
    test_path_under = r'/nfs1/schatter/IXI/IXI-T1/Under/1DVarden30Mask' 
    val_path_fully = r'/nfs1/schatter/IXI/IXI-T1/Fully'
    val_path_under = r'/nfs1/schatter/IXI/IXI-T1/Under/1DVarden30Mask'
    ...
    output_path = r'/nfs1/schatter/Output/Enterprise/v1-Gen3/IXI-T1/HH/3D'
    output_folder = 'Attempt7-IXIT1HH-1DVarden30Mask-Resnet3Dv2b_4_14start32_updown2-MultiSSIMLoss-3D'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
elif(pc_name == 'brain'):
    ##For GPU18 Cluster - For Undersampled Images
    ...
    output_folder = 'Attempt8-IXIT2SuResHH-interpolated-randomthick-Resnet3Dv2b10start16_3-MultiSSIMLoss-3D'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
