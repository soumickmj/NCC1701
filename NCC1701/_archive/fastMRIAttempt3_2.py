...
save_frequency = 1
IsResume = False
CheckpointPath = r"D:\Output\Gen3\fastMRI\Skyra\AllSlices\Attempt3_2-fastMRISkyra-AccFact4Center08-CUNet-MSELossImg-AllSlices!!!!\checkpoints\checkpoint.pth.tar"
...
Model = importlib.import_module('model.ModelFastMRI2').Model 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    test_path_fully = r'E:\Datasets\FastMRI\raw\multicoil_train\multicoil_train' #TODO: Hotfix done, using val set in place of test as test doesn't contain fully sampled kspace
    val_path_fully = r'E:\Datasets\FastMRI\raw\multicoil_train\multicoil_train'
    ds_split_xlsx_train = r"E:\Datasets\FastMRI\raw\multicoil_train\headers.xlsx"
    ds_split_xlsx_test = r"E:\Datasets\FastMRI\raw\multicoil_train\headers.xlsx"
    ds_split_xlsx_val = r"E:\Datasets\FastMRI\raw\multicoil_train\headers.xlsx"
    output_path = r'D:\Output\Gen3\fastMRI\Skyra\AllSlices'
    output_folder = 'Attempt3_3_2-fastMRISkyra-AccFact4Center08-CUNet-MSELossImg-AllSlices-1samedata'
