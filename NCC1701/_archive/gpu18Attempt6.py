...
maskORom_path = r"/home/schatter/Code/EnterpriseV1/Gen2/v3-20190522/1DVarden30Mask.mat"
...
#### Basic parameters
domain = 'fourier' #In which domain, network should work? Acceptable values: | fourier | real_fourier | abs_of_fourier | real_of_fourier | abs_of_real_fourier | real_of_real_fourier | hartley | image |
...
save_frequency = 20
IsResume = False
CheckpointPath = r"/raid/scratch/schatter/Output/Enterprise/v1-Gen2/Attempt6_2-Varden1D30SameMask-LinearResnet2Dv214L1LossBS64Ep500-fourier-slice51/checkpoints/checkpoint.pth.tar"
...
#netModel = importlib.import_module('model.ResNet.Resnet2Dv2b14').ResNet(2)
#netModel = importlib.import_module('model.kSpace.ResNet.AdvResnet2Dv2').ResNet 
from model.kSpace.ResNet.LinearResnet2Dv2_ReducedIN import ResNet
netModel = ResNet(n_channels=n_channels, underDownStrategy='interpolate', missingMask=missingMask)
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = '/raid/scratch/schatter/Dataset/MATs/OASIS-Subset1-Varden1D30SameMask-Slice51/ds1-fourier-train'
    train_path_under = '/raid/scratch/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/raid/scratch/schatter/Dataset/MATs/OASIS-Subset1-Varden1D30SameMask-Slice51/ds1-fourier-test'
    ...
    output_folder = 'Attempt6_2-Varden1D30SameMask-LinearResnet2Dv214L1LossBS64Ep500-fourier-slice51'
    output_folder = 'Attempt6-Varden1D30SameMask-LinearResnet2Dv214L1Loss-fourier-slice51'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
