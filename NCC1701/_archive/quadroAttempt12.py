...
###Resnet34	2DSingleSlice	No	1470	neumann	8	Alex3	T2-PD
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_fully = r'D:\Datasets\AlexMultiCon4\axialSORTED\PD\Train'
    train_path_under = r'D:\Datasets\AlexMultiCon4\axialSORTED\T2\Train'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\AlexMultiCon4\axialSORTED\PD\Test'
    test_path_under = r'D:\Datasets\AlexMultiCon4\axialSORTED\T2\Test'
    test_entension_under = 'nii.gz'
    ...
    train_path_fully = '/home/soumick/Datasets/AlexMultiCon3/Repro-DeepLearning/axial/Sorted-Vol1/PD/Train'
    train_path_under = '/home/soumick/Datasets/AlexMultiCon3/Repro-DeepLearning/axial/Sorted-Vol1/T2/Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/home/soumick/Datasets/AlexMultiCon3/Repro-DeepLearning/axial/Sorted-Vol1/PD/Test'
    test_path_under = '/home/soumick/Datasets/AlexMultiCon3/Repro-DeepLearning/axial/Sorted-Vol1/T2/Test'
    test_entension_under = 'nii.gz'
    output_path = '/home/soumick/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt12-Alex3T2PD-Resnet34-1470-2DSingle'
    output_path = os.path.join(output_path, output_folder)
elif(pc_name == neumann_name):
    print('Its Neumann Cluster')
    ##For Neumann - For Undersampled Images
    train_path_fully = '/scratch/tmp/schatter/Datasets/AlexMultiCon3/Repro-DeepLearning/axial/Sorted-Vol1/PD/Train'
    train_path_under = '/scratch/tmp/schatter/Datasets/AlexMultiCon3/Repro-DeepLearning/axial/Sorted-Vol1/T2/Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/AlexMultiCon3/Repro-DeepLearning/axial/Sorted-Vol1/PD/Test'
    test_path_under = '/scratch/tmp/schatter/Datasets/AlexMultiCon3/Repro-DeepLearning/axial/Sorted-Vol1/T2/Test'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt9-Alex3T2PD-Resnet34-1470-2DSingle'
    output_path = os.path.join(output_path, output_folder)
else:
