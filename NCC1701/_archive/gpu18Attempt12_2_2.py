...
netModel = ImgKSPNet(n_channels, ksp_bottle_neck_size=64, ksp_model_type='simplelinear', multilossreturn=True)
IsImgKSPNet = True
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt12_2_2-Uniform28-4step-ImgKSPNet_Bottle64simple_Resnet2Dv2b14-image-51to80SingleEach'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
