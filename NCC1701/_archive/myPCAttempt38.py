...
IsResume = False
CheckpointPath = r"D:\Output\Attempt37-WithValidate-OASIS-Uniform28-4step_Fresh-Resnet2Dv2SSIMLoss-51to80SingleEach\checkpoints\checkpoint.pth.tar"
...
#netModel = importlib.import_module('model.kSpace.ResNet.AdvResnet2D').ResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Uniform28-4step-51to80SingleEach\ds1-image-train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Uniform28-4step-51to80SingleEach\ds1-image-test'
