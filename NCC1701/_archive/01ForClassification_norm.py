...
if __name__ == '__main__':
    ...
    test_name = 'WaveletImageCorrectNClassifyNet_Trainable_DO_NOBranchSplit_Norm_BothMSELoss'
    ...
    num_epochs = 50
    loader_params = {'batch_size': 10, 'shuffle': False, 'num_workers': 0} #shuffle not needed as using SubsetRandomSampler
    ...
    if runOnlyTest:
        dataset = MoCoH5DS(h5path4test, device=device, rotatenorm=True)
        ...
        dataset = MoCoH5DS(h5path, device=device, rotatenorm=True)
