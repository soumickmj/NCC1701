...
###Resnet34	2DSingleHartley	No	200	neumann	11	Alex2	T1-PD			
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_fully = '/scratch/tmp/schatter/Datasets/AlexMultiCon2/IXI-Dataset/PD/Guys-Train'
    train_path_under = '/scratch/tmp/schatter/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/AlexMultiCon2/IXI-Dataset/PD/Guys-Test'
    test_path_under = '/scratch/tmp/schatter/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Test'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt11-Alex2T1PDHart-Resnet34-2DSingle'
    output_path = os.path.join(output_path, output_folder)
else:
