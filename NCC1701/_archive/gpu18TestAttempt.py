...
mat_contents = sio.loadmat(r"/home/schatter/Code/EnterpriseV1/Gen2/v1-20190408/1DVarden30Mask.mat")
...
netModel = importlib.import_module('model.kSpace.ResNet.Resnet2Dv2b14_ks').ResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt0_18-Test-Varden1D30SameMask-Resnet2Dv214ksMSELoss-fourier-slice51'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
...
#ApplyDataConsis(output_path, False, True, r'/home/schatter/Code/EnterpriseV1/Gen2/v1-20190408/1DVarden30Mask.mat')
