...
###Resnet34	2DSingleSlice	No	200	22		OASIS-varden30-samemask	undersampled
...
IsResume = True
CheckpointPath = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/Attempt22Sig-OASISVarden30SameMask-Resnetv2D-2SingleSlice50/checkpoints/checkpoint.pth.tar'
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Subset1/Registered-Undersampled/Varden30New'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered'
    test_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered-Undersampled/Varden30New'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt22Sig_X-OASISVarden30SameMask-Resnetv2D-2SingleSlice50'
    output_path = os.path.join(output_path, output_folder)
else:
