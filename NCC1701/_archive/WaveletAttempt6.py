...
from utils.MRITorchDSTransforms import CorruptByMotion, TransformFullyUpdateUnder, TransformAndUpdateFullyUnder
...
#transform_ksp = TransformAndUpdateFullyUnder(transforms.Compose([to_tensor]))
...
save_frequency = 1
IsResume = True
CheckpointPath = r"D:\Output\Gen3\OASIS1\Attempt6-OASISSubset1-Varden2D30-PraveenRes2WaveletTrainable-SSIMLoss-Slice50-at134ep\checkpoints\checkpoint.pth.tar"
...
netModel = importlib.import_module('model.Wavelet.Praveen').Praveen(trainable_wavelets=True) 
...
lrDecayNEpoch = 500 #4 #Decay the learning rate after every 4th epoch
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'E:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden2D30SameMask-Slice50\ds1-image-train'
    test_path_fully = r'E:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden2D30SameMask-Slice50\ds1-image-test' 
    val_path_fully = r'E:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden2D30SameMask-Slice50\ds1-image-test'
    ds_split_xlsx_train = None
    ds_split_xlsx_test = None
    ds_split_xlsx_val = None
    output_path = r'D:\Output\Gen3\OASIS1'
    output_folder = 'Attempt6-OASISSubset1-Varden2D30-PraveenRes2WaveletTrainable-SSIMLoss-Slice50-at134ep'
...
if(modelType_actual == '2DMultiSlice'):
    ...
    MultisliceCombiner(output_path, output_path+'-Combined', False, False)
