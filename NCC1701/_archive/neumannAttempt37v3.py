...
IsResume = False
CheckpointPath = r"D:\Output\Attempt19-WithValidate-OASISVarden30SameMask-ResNet2Dv2SSIMLoss-SingleSlice50\checkpoints\model_best.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = '/scratch/tmp/schatter/Datasets/MATs/20190320Fresh/OASIS-Subset1-Varden30SameMask-Slice50/ds1-image-train'
    train_path_under = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Train'
    train_entension_under = 'nii.gz'
    ...
    output_folder = 'Attempt37_v3-WithValidate-Varden30SameMask-Resnet2Dv2SSIMLoss-Slice50'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
