...
if(pc_name == 'intelnuc03'):
    ...
    train_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Subset1/Registered-Undersampled/gauss30different'
    train_entension_under = 'nii.gz'
    ...
    output_folder = 'Attempt34-OASISGauss30Different-ResnetSig-2DSingleSlice50'
    output_path = os.path.join(output_path, output_folder)
else:
