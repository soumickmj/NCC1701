...
maskORom_path = r"/home/schatter/Code/EnterpriseV1/Gen2/v4-20190618/Radial60spGA2pixelcenter.mat"
...
save_frequency = 1
IsResume = True
CheckpointPath = r"/raid/scratch/schatter/Output/Enterprise/v1-Gen2/Attempt11_3-Radial60GA-Resnet2Dv2b14XtremeSupreme-image-51to80SingleEach/checkpoints/checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = '/raid/scratch/schatter/Dataset/MATs/OASIS-Subset1-Radial60GA-51to80SingleEach/ds1-image-train'
    train_path_under = '/raid/scratch/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/raid/scratch/schatter/Dataset/MATs/OASIS-Subset1-Radial60GA-51to80SingleEach/ds1-image-test'
    ...
    output_folder = 'Attempt11_3-Radial60GA-Resnet2Dv2b14XtremeSupreme-image-51to80SingleEach'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
