...
###Resnet34	2DSingleSlice	No	1800	neumann	9	Alex4	T2-PD				
...
slicenoTrain = 8 #Only for 2DSingleSlice
slicenoTest = 8 #Only for 2DSingleSlice
...
dsClass = importlib.import_module('utils.TorchDS.AlexDS4_NoMask').MRITorchDS 
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_fully = '/home/soumick/Datasets/AlexMultiCon4/axial/PD/Train'
    train_path_under = '/home/soumick/Datasets/AlexMultiCon4/axial/T2/Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/home/soumick/Datasets/AlexMultiCon4/axial/PD/Test'
    test_path_under = '/home/soumick/Datasets/AlexMultiCon4/axial/T2/Test'
    test_entension_under = 'nii.gz'
    output_path = '/home/soumick/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt12-Alex4T2PD-Resnet34-1800-2DSingle'
    output_path = os.path.join(output_path, output_folder)
elif(pc_name == neumann_name):
    print('Its Neumann Cluster')
    ##For Neumann - For Undersampled Images
    train_path_fully = '/scratch/tmp/schatter/Datasets/AlexMultiCon4/axialSORTED/PD/Train'
    train_path_under = '/scratch/tmp/schatter/Datasets/AlexMultiCon4/axialSORTED/T2/Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/AlexMultiCon4/axialSORTED/PD/Test'
    test_path_under = '/scratch/tmp/schatter/Datasets/AlexMultiCon4/axialSORTED/T2/Test'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt9-Alex4T2PD-Resnet34-1800-2DSingle'
    output_path = os.path.join(output_path, output_folder)
else:
