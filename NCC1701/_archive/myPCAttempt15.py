...
netModel = importlib.import_module('model.ResNet.Resnet2DSoft2D').ResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-varden30SameMask-Slice51\ds2-image-train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-varden30SameMask-Slice51\ds2-image-test'
    ...
    output_folder = 'Attempt15-OASISVarden30SameMask-Resnet2DSoft2D-SingleSlice51'
