...
netModel = importlib.import_module('model.ResNet.Resnet2D').ResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\Miniset'
    train_path_under = r'D:\Datasets\Miniset'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\Miniset'
    test_path_under = r'D:\Datasets\Miniset'
    test_entension_under = 'nii.gz'
    output_path = r'D:\Output'
    output_folder = 'Attempt0-TestF'
