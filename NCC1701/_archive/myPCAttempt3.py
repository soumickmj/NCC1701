...
IsResume = True
CheckpointPath = r'D:\Output\Attempt3-OASISVarden30SameMask-Densenet2Dv2-d100g12r50-2SingleSlice50\checkpoints\checkpoint.pth.tar'
...
netModel = importlib.import_module('model.DenseNet.Densenet2Dv2').Densenetv2 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt3X-OASISVarden30SameMask-Densenet2Dv2-d100g12r50-2SingleSlice50'
...
#model = Model(mask, domain, batch_size, type = modelType, pin_memory = pinMemory) # With MASK
