...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-Radial60-Slice50\ds1-image-train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-Radial60-Slice50\ds1-image-test'
    ...
    output_folder = 'Attempt22-WithValidate-OASISRadial60-ResNet2Dv2SSIMLoss-SingleSlice50'
