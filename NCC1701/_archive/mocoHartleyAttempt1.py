...
netModel = importlib.import_module('model.kSpace.CInvUNet').CInvUNet 
NetType = 1 # 0: ordinary, 1: KSPNet4FastMRI, 2: Super Res Net, 3: KSPNet
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt2-MoCoHartleyShepLog-CInvUNet-SSIMLossInImg'
