...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt1-IXIT2SuResHH-randomthick-Resnet3Dv2b10start16-MSELoss-3D'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
elif(pc_name == 'brain'):
    ##For GPU18 Cluster - For Undersampled Images
    ...
    output_folder = 'Attempt5-IXIT2SuResHH-randomthick-Resnet3Dv2b10start16_2-MultiSSIMLoss-3D'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
