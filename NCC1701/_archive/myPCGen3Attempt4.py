...
maskORom_path = r"1DVarden30Mask.mat"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'E:\Datasets\IXI\MATs\IXI-T1\Guys\Slice60to90\Varden1D05SameMask\train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'E:\Datasets\IXI\MATs\IXI-T1\Guys\Slice60to90\Varden1D05SameMask\test'
    test_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TestSet\varden30SameMask'
    test_entension_under = 'nii.gz'
    val_path_fully = r'E:\Datasets\IXI\MATs\IXI-T1\Guys\Slice60to90\Varden1D05SameMask\val'
    ...
    output_folder = 'Attempt4-IXIT1GuysVarden1D05-Resnet2Dv214PReLU-SSIMLoss-Slice60to90'
    ...
    train_path_fully = r'/nfs1/schatter/IXI/MATs/IXI-T1/Guys/AllSlices/1DVarden30Mask/train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'/nfs1/schatter/IXI/MATs/IXI-T1/Guys/AllSlices/1DVarden30Mask/test'
    test_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TestSet\varden30SameMask'
    test_entension_under = 'nii.gz'
    val_path_fully = r'/nfs1/schatter/IXI/MATs/IXI-T1/Guys/AllSlices/1DVarden30Mask/val'
    val_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TestSet\varden30SameMask'
    val_entension_under = 'nii.gz'
    output_path = r'/raid/scratch/schatter/Output/Enterprise/v1-Gen3/IXI-T1/Guys/AllSlices'
    output_folder = 'Attempt7-IXIT1GuysVarden1D30-Resnet2Dv214PReLU-SSIMLoss-AllSlices'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
