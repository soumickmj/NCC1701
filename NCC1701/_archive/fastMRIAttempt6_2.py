...
save_frequency = 1
IsResume = False
CheckpointPath = r"D:\Output\Gen3\fastMRI\Skyra\AllSlices\Attempt5-fastMRISkyra-AccFact4Center08-CUNetResNetv214-MultiSSIMsumImg-AllSlices\checkpoints\checkpoint.pth.tar"
...
netModel = importlib.import_module('model.ResNet.Resnet2Dv2b14').ResNet(n_channels=n_channels,final_out_sigmoid=False) 
...
loss_func = MultiSSIM.MultiSSIM(reduction='sum')
IsNegetiveLoss = True
loss_type = 1
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt6-fastMRISkyra-AccFact4Center08-ResNetv214-MultiSSIMsumImg-AllSlices'
