...
IsResume = True
CheckpointPath = r"D:\Output\Attempt30_2-WithValidate-OASISVarden30SameMask_Fresh-Resnet2Dv2SSIMLoss-SingleSlice50\checkpoints\model_best.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt30_2-WithValidate-OASISVarden30SameMask_Fresh-Resnet2Dv2SSIMLoss-SingleSlice50'
