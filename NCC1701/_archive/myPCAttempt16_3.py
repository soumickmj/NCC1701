...
IsResume = False
CheckpointPath = r'D:\Output\Attempt16_2-OASISVarden30SameMask-Resnet2Dv2-SingleSlice51\checkpoints\checkpoint.pth.tar'
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt16_3-WithValidate-OASISVarden30SameMask-Resnet2Dv2-SingleSlice51'
...
if IsGAN:
    ...
    model.CreateModel(netModel, IsCuda = IsCuda, IsMultiGPU = IsMultiGPU, n_channels=n_channels, 
                      initialLearningRate=initialLearningRate, lrDecayNEpoch=lrDecayNEpoch, lrDecayRate=lrDecayRate, betas=(beta1, beta2), epsilon=epsilon, loss_func=loss_func, optimizer=optimizer)
