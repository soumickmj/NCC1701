...
IsResume = True
CheckpointPath = r"D:\Output\Attempt34_Redo-WithValidate-OASIS-CombinedBest2_Fresh-Resnet2Dv2SSIMLoss-SingleSlice50\checkpoints\checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-CombinedBest2-Slice50\ds1-image-train'
    ...
    output_folder = 'Attempt34_Redo-WithValidate-OASIS-CombinedBest2_Fresh-Resnet2Dv2SSIMLoss-SingleSlice50'
