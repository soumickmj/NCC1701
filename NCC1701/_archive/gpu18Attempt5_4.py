...
#netModel = importlib.import_module('model.kSpace.ResNet.AdvResnet2Dv4').ResNet 
from model.kSpace.ResNet.AdvResnet2Dv4 import ResNet
...
if IsGAN:
    ...
    Model = importlib.import_module('model.Model_TempMissingMask').Model 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt5_4-Varden1D30SameMask-AdvResnet2Dv414L1Loss-fourier-slice51'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
...
ApplyDataConsis(output_path, False, True, r"/home/schatter/Code/EnterpriseV1/Gen2/v3-20190522/1DVarden30Mask.mat")
