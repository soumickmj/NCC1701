...
IsResume = True
CheckpointPath = r'D:\Output\Attempt19-WithValidate-OASISVarden30SameMask-ResNet2Dv2SSIMLoss-SingleSlice50\checkpoints\checkpoint.pth.tar'
...
if(pc_name == 'BMMR-Soumick'):
    ...
    test_path_fully = r'D:\Datasets\MATs\OASIS-Subset1-varden30SameMask-Slice50\ds1-image-only1test'
    ...
    output_folder = 'Attempt19_StepTest'
...
#    return hook
#for i in range(len(model.net.model)):
#    if 'Conv' in str(model.net.model[i]):
#        model.net.model[i].register_forward_hook(get_activation(str(index)))
#        index += 1
