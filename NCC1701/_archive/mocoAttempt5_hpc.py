...
save_frequency = 1
IsResume = True
CheckpointPath = r"/mnt/beegfs/vc-a/tmp/schatter/Output/Gen3/IXI-T1-MoCo/HH/Attempt5-IXIT1MoCoHH-RotMax35-tx0ty0-Resnet2Dv2b14-SSIMLoss-Slice60to90/checkpoints/checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_path = r'D:\Output\Gen3\IXI-T1-MoCo\Guys'
    output_folder = 'Attempt5-IXIT1MoCoGuys-RotMax35-tx0ty0-Resnet2Dv2b14-SSIMLoss-Slice60to90'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
elif(pc_name in neumann_name):
    ##For Neumann - For Undersampled Images
    tb_logroot = '/mnt/beegfs/vc-a/tmp/schatter/Output/Neural/TensorBoardLogs/Ent-Gen3'
    train_path_fully = r'/mnt/beegfs/vc-a/tmp/schatter/Datasets/MATs/IXI-T1/HH/Slice60to90/Varden1D30SameMask/train'
    test_path_fully = r'/mnt/beegfs/vc-a/tmp/schatter/Datasets/MATs/IXI-T1/HH/Slice60to90/Varden1D30SameMask/test'
    val_path_fully = r'/mnt/beegfs/vc-a/tmp/schatter/Datasets/MATs/IXI-T1/HH/Slice60to90/Varden1D30SameMask/val'
    ds_split_xlsx_train = None
    ds_split_xlsx_test = None
    ds_split_xlsx_val = None
    output_path = r'/mnt/beegfs/vc-a/tmp/schatter/Output/Gen3/IXI-T1-MoCo/HH'
    output_folder = 'Attempt5-IXIT1MoCoHH-RotMax35-tx0ty0-Resnet2Dv2b14-SSIMLoss-Slice60to90'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
