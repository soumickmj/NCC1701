...
startingSelectSlice = 40 #Only for 2DSelectMultiSlice and 3DSelectSlice
startingSelectSlice = startingSelectSlice + 1 #As array starts from 0
endingSelectSlice = 70 #Only for 2DSelectMultiSlice and 3DSelectSlice
...
if(pc_name == 'intelnuc03'):
    ...
    test_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered-Undersampled/Varden251vol'
    test_entension_under = 'nii'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt12-OASIS1Varden25-Resnet34-2DMultiSlice'
    output_path = os.path.join(output_path, output_folder)
else:
