...
IsResume = False
CheckpointPath = r"D:\Output\Attempt32_2-WithValidate-Radial60GA_Fresh-Resnet2Dv2SSIMLoss-SingleSlice50\checkpoints\model_best.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Radial60GA-Slice50\ds1-image-train'
    ...
    output_folder = 'Attempt32_2_Redo-WithValidate-Radial60GA_Fresh-Resnet2Dv2SSIMLoss-SingleSlice50'
