...
save_frequency = 1
IsResume = True
CheckpointPath = r"Attempt11-Varden1D30SameMask-Resnet2Dv2b14XtremeSupreme-image-51to80SingleEach/checkpoints/checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt11-Varden1D30SameMask-Resnet2Dv2b14XtremeSupreme-image-51to80SingleEach'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
