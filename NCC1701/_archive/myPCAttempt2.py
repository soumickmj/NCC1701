...
IsResume = False
CheckpointPath = r'D:\Output\Attempt2-OASISVarden30SameMask-DenseResNet34-d100g12r50-2SingleSlice50\checkpoints\checkpoint.pth.tar'
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt2-OASISVarden30SameMask-DenseResNet34-d100g12r50-2SingleSlice50'
