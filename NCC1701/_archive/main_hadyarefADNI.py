...
gpuID = "0"
adniCSV = None#r"E:\Datasets\ADNI\MCI_SMC_T1_9_19_2019.csv" #If not ADNI, then set to None
adniAcqTyp = 'MPRAGE' #Only used if the previous set to not none (i.e. using ADNI Dataset)
...
modelType4Actual = '2DMultiSlice'
CheckpointPath = r"E:\TrainedModels\Enterprise_Gen3\Resnet2Dv2b14\IXI-T1\HH\Final_Checkpoint\h7_AllSlices_Varden1D30.pth.tar"
...
test_path_fully = r'E:\Datasets\ResNetTestSet\Skyra\MATs_IXIRot\OneSlice\1DVarden30Mask'
test_path_under = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Test'
test_entension_under = 'nii.gz'
output_path = r"E:\Datasets\ResNetTestSet\Skyra\MATs_IXIRot\OneSlice\OutputIXI"
output_folder = 'Varden1D30_Final'
IsRadial = False
...
if IsGAN:
    ...
    Model = importlib.import_module('model._backward.ModelSSIMLoss').Model 
...
if adniCSV is None:
    ...
    from support.ResultAnalyzerExtendedADNI import AnalyzeResultFolder
    AnalyzeResultFolder(output_path, '', adniCSV, adniAcqTyp, isAnyCorrected=True, useExtended=True)
...
if(modelType4Actual == '2DMultiSlice'):
    ...
    if adniCSV is None:
        ...
        AnalyzeResultFolder(output_path+'-Combined', '', adniCSV, adniAcqTyp, isAnyCorrected=True, useExtended=True)