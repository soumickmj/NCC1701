...
IsResume = True
CheckpointPath = r"/scratch/tmp/schatter/Output/Neural/EnterpriseV1-gen2/Attempt41-WithValidate-Radial60GA-Resnet2Dv2SSIMLoss-51to80SingleEach/checkpoints/checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = '/scratch/tmp/schatter/Datasets/MATs/20190320Fresh_Correct/OASIS-Subset1-Radial60GA-51to80SingleEach/ds1-image-train'
    train_path_under = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Train'
    train_entension_under = 'nii.gz'
    ...
    output_folder = 'Attempt41-WithValidate-Radial60GA-Resnet2Dv2SSIMLoss-51to80SingleEach'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
