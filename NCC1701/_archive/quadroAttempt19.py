...
For Example,
Fully: PD, Under: T2 - For Converting T2 to PD

"""

###UnetPaper	2DSingleSlice	No	2000	19		OASIS-varden30	undersampled			
...
netModel = importlib.import_module('model.UNet.UnetMRIPaper').UNet 
...
if IsGAN:
    ...
    Model = importlib.import_module('model.ModelMRIPaper').Model 
...
initialLearningRate = 0.001#0.0002 #0.0001 #0.1
lrDecayNEpoch = 3000 #4 #Decay the learning rate after every 4th epoch. Larger than n_epoch, so never going to decay
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_fully = r'D:\Datasets\AlexMultiCon2\IXI-Dataset\PD\Guys-Train'
    train_path_under = r'D:\Datasets\AlexMultiCon2\IXI-Dataset\T1\Guys-Train'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\AlexMultiCon3\Repro-DeepLearning\axial\Sorted-Vol1\PD\Test'
    test_path_under = r'D:\Datasets\AlexMultiCon3\Repro-DeepLearning\axial\Sorted-Vol1\T2\Test'
    test_entension_under = 'nii.gz'
    ...
    train_path_fully = '/home/soumick/Datasets/Datasets/OASIS1/TrainSet1/Registered'
    train_path_under = '/home/soumick/Datasets/Datasets/OASIS1/TrainSet1/Registered-Undersampled/varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = '/home/soumick/Datasets/Datasets/OASIS1/TestSet1/Registered'
    test_path_under = '/home/soumick/Datasets/Datasets/OASIS1/TestSet1/Registered-Undersampled/varden30SameMask'
    test_entension_under = 'nii.gz'
    output_path = '/home/soumick/Output/Neural/EnterpriseV1/'
    output_folder = 'Attempt19-OASISVarden30samemask-UnetMRIPaperOriginalParam-2DSingleSlice50'
    output_path = os.path.join(output_path, output_folder)
elif(pc_name == neumann_name):
    print('Its Neumann Cluster')
    ##For Neumann - For Undersampled Images
    train_path_fully = '/scratch/tmp/schatter/Datasets/OASIS1/Subset1/Registered'
    train_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Subset1/Registered-Undersampled/varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered'
    test_path_under = '/scratch/tmp/schatter/Datasets/OASIS1/Testset1/Registered-Undersampled/varden30SameMask'
    test_entension_under = 'nii.gz'
    output_path = '/scratch/tmp/schatter/Output/Neural/EnterpriseV1/'
    output_folder = 'QuadroAttempt19-OASISVarden30samemask-UnetMRIPaperOriginalParam-2DSingleSlice50'
    output_path = os.path.join(output_path, output_folder)
else:
...
if(run_mode == 0):
    train_set, _ = model.IntitializeMRITorchDS(dsClass, slicenoTrain, startingSelectSlice, endingSelectSlice, train_path_fully, train_path_under, train_entension_under, n_workers_train, getROIMode)
    ...
    _, train_setDS = model.IntitializeMRITorchDS(dsClass, slicenoTrain, startingSelectSlice, endingSelectSlice, train_path_fully, train_path_under, train_entension_under, n_workers_train, getROIMode) #TODO , sliceno = slicenoTrain
    ...
    test_set, _ = model.IntitializeMRITorchDS(dsClass, slicenoTest, startingSelectSlice, endingSelectSlice, test_path_fully, test_path_under, test_entension_under, n_workers_test, getROIMode)
