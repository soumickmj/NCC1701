...
save_frequency = 1
IsResume = False
CheckpointPath = r"/raid/scratch/schatter/Output/Enterprise/v1-Gen2/Attempt11_2-Uniform28-4step-Resnet2Dv2b14XtremeSupreme-image-51to80SingleEach/checkpoints/checkpoint.pth.tar"
...
netModel = ImgKSPNet(n_channels, ksp_bottle_neck_size=64, ksp_model_type='complexlinear', multilossreturn=True)
IsImgKSPNet = True
...
if IsGAN:
    ...
    Model = importlib.import_module('model.ModelSSIMLossExperimental').Model 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt13_2_2-Uniform28-4step-ImgKSPNet_Bottle64complex_Resnet2Dv2b14-image-51to80SingleEach'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
else:
