...
###Resnet34	2DSingleFourier	No	200	quadro	13	Alex2	T1-PD			
...
if(pc_name == 'intelnuc03'):
    ...
    train_path_fully = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/PD/Guys-Train'
    train_path_under = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Train'
    train_entension_under = 'nii.gz'
    test_path_fully = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/PD/Guys-TEst'
    ...
    output_folder = 'Attempt13-Alex2T1PD-Resnet34-2DSingle'
    output_path = os.path.join(output_path, output_folder)
