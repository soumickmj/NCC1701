...
IsResume = True
CheckpointPath = r"D:\Output\Attempt36-WithValidate-OASIS-varden30-samemask_Fresh-Resnet2Dv2SSIMLoss-51to80SingleEach\checkpoints\checkpoint.pth.tar"
...
if(pc_name == 'BMMR-Soumick'):
    ...
    train_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden30SameMask-51to80SingleEach\ds1-image-train'
    train_path_under = r'D:\Datasets\OASIS1\Undersampled-Registered\TrainSet\varden30SameMask'
    train_entension_under = 'nii.gz'
    test_path_fully = r'D:\Datasets\MATs\20190320Fresh\OASIS-Subset1-Varden30SameMask-51to80SingleEach\ds1-image-test'
    ...
    output_folder = 'Attempt36-WithValidate-OASIS-varden30-samemask_Fresh-Resnet2Dv2SSIMLoss-51to80SingleEach'
