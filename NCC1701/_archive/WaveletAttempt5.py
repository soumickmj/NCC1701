...
netModel = importlib.import_module('model.Wavelet.ResPraveen').Praveen(trainable_wavelets=True) 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt5-OASISSubset1-Varden1D30-ResPraveenWaveletTrainable-SSIMLoss-Slice50'
