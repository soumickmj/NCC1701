...
save_frequency = 1
IsResume = False
CheckpointPath = r'/home/sciarra/NCC1701/Output/Enterprise/v1-Gen3/IXI-T2-SuRes/HH/3D/Attempt1-IXIT2SuResHH-randomthick-Resnet3Dv2b10start16-MSELoss-3D/checkpoints/checkpoint.pth.tar'
...
netModel = importlib.import_module('model.ResNet.Resnet3Dv2b14_3').ResNet 
...
if(pc_name == 'BMMR-Soumick'):
    ...
    output_folder = 'Attempt5-IXIT1HH-1DVarden30Mask-Resnet3Dv2b_3_14start32_updown1-MultiSSIMLoss-3D'
    output_path = os.path.join(output_path, output_folder)
    tb_logpath = os.path.join(tb_logroot, output_folder)
elif(pc_name == 'brain'):
    ##For GPU18 Cluster - For Undersampled Images
