...
sliceno = 51 #Only for 2DSingleSlice
...
pinMemory = False
IsRadial = False
filename_filter = None#'9'#None#'mpr-1' #mpr-1 for OASIS, for rest send None
...
if(pc_name == 'BMMR-Soumick'):
    ...
    path_fully = r'E:\Datasets\OASIS-Lesion\fully_rotatedcorrect'
    path_under = r'E:\Datasets\OASIS-Lesion\under_rotatedcorrect\1DVarden30Mask'
    entension_under = 'nii.gz'
    output_path = r'E:\Datasets\OASIS-Lesion\MATs'
    output_folder = '1DVarden30Mask'
...
obj = TorchDS2MAT(domain, IsRadial, modelType, pinMemory, dsClass, sliceno, startingSelectSlice, endingSelectSlice, path_fully, path_under, entension_under, getROIMode, mask, filename_filter)
