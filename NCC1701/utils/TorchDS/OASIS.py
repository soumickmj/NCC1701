...
class MRITorchDS(Dataset):
    ...
    def __init__(self, root_fully, root_under, fileExtension_under, domain='abs_fourier', transform=None, getROIMode=None, undersampling_mask=None, filename_filter = 'mpr-1'):
        """
