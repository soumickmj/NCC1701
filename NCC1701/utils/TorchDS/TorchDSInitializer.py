...
class TorchDSInitializer(object):
    ...
    def InitializeDS(self, domain, IsRadial, sliceHandleType, batchSize, pin_memory, dsClass, sliceno, startingSelectSlice, endingSelectSlice, folder_path_fully, folder_path_under, extension_under, num_workers, getROIMode, undersampling_mask=None, filename_filter=None, splitXSLX=None, split2use=None):
        if(domain == 'image'):
