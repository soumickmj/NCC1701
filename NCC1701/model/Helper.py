...
class Helper(object):
    ...
    def torchFFT(self, tensor):
        ####NOTE: Depreciated in favour of Math.FrequencyTransofrmsTorch
        #Only works with SingleSlice and batch size 1. Still has mistakes
    ...
    def torchIFFT(self, tensor_k):
        ...
        tensor = torch.irfft(tensor_k[0,0,:,:,:], signal_ndim=2, normalized=True, onesided=False)
