...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        #v2: residual of v1 + input to the residual blocks added back with the output - removed residual of v1
        out = self.intialConv(x) #256
        out = self.downsam(out) #64
    ...
    #def forward(self, x):
    #    #v4: residual of v3 + input of the initial conv added back with the output
    ...
    #def forward(self, x):
    #    #v5: residual of v4 + output of the initial conv added back with the input of final conv
