...
class Model(object):
    ...
    def TrainOneEpoch(self, dataloader, epoch, n_epoch):
        ...
        for i, data in enumerate(dataloader, 0): # We iterate over the images of the dataset (training).
            ...
            if self.IsImgKSPNet:
                generated = self.net(fully) # We forward propagate the undersampled images into the neural network of the generator to get some "improved" images.
            else:
