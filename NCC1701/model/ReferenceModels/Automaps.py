"""
Code is from https://github.com/js3611/dAUTOMAP
It's the official code from the first author of dAutomap Jo Schlemper
This script contains code for both Automap and dAutomap
