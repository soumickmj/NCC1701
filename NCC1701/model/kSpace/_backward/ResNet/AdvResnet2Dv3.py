...
missingMask and missingMaskDown have been calculated during forward pass, based on the input data. Then those masks been used for data consistancy, that been performed in all layers including residual blocks.
"""
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        missingMask = self.getMissingMask(under)
