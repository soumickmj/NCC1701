...
import numpy as np
from model.Attention.ResNet.Ref.basic_layers import ResidualBlock
from model.Attention.ResNet.Ref.attention_module import AttentionModule_stage1, AttentionModule_stage2, AttentionModule_stage3, AttentionModule_stage0
from model.Attention.ResNet.Ref.attention_module import AttentionModule_stage1_cifar, AttentionModule_stage2_cifar, AttentionModule_stage3_cifar
...
m=ResidualAttentionModel_448input()
z=torch.zeros(5,3,448,448)
o=m(z)
print('test')
...
m=ResidualAttentionModel_92()
z=torch.zeros(5,3,224,224)
o=m(z)
print('test')
