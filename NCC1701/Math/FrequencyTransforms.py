...
def fft2c(x, shape=None, axes=(-2, -1), shiftAxes = (0,1), normalize=None): # originally was axes=(-2,-1), shiftAxes = None
    ...
    f = np.fft.fftshift(np.fft.fft2(np.fft.ifftshift(x, axes=axes), axes=axes, s=shape, norm=normalize), axes=axes)
    return f
