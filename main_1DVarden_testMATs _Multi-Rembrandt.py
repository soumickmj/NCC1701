...
gpuID = "1"
maskORom_path = r"C:\Klinikum_PC\directory to extract\enterprisencc1701_hadya-master\1DVarden30Mask.mat"
...
tb_logroot = r"C:\Klinikum_PC\BRATs2019\Output\TensorBoardLogs"
test_path_fully = r"C:\Klinikum_PC\BRATs2019\Saggital\Mats\MICCAI_BraTS_2019_Data_Training\HGG\Varden30_AllSlice"      #MATs folder
...
output_path = r"C:\Klinikum_PC\BRATs2019\Output\MICCAI_BraTS_2019_Data_Training\HGG\h7"
output_folder = r"Attempt1-Brats-Varden1D30_AllSlice-h7_AllSlices_Varden1D30" 
IsRadial = False
RunOnly4Combine = True   #True when you only wanna combine the test resulted nifties and not run the test
