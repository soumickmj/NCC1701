...
from fastmriGit.pl_modules.unet_module import UnetModule as Net 
from utils.GetFreeGPU import get_free_gpu
from model.Model_fastMRIBaseline import Model
...
gpuID = "0"
maskORom_path = r"/mnt/MEMoRIAL/MEMoRIAL_M1.p-4/Chatterjee/Results/ResNetPaper/CodeForEval/enterprisencc1701_hadya/1DVarden30Mask.mat"
...
tb_logroot = r"/run/media/soumick/MicksDen/Results/ResNetPaper/fastMRIBaseline/IXI/UNet/TBLogs"
train_path_fully = r'/run/media/soumick/MicksDen/Datasets/IXI/MATs/IXI-T1/HH/AllSlices/1DVarden30Mask/train'
test_path_fully = r"/run/media/soumick/MicksDen/Datasets/IXI/MATs/IXI-T1/HH/AllSlices/1DVarden30Mask/test"
output_path = r"/run/media/soumick/MicksDen/Results/ResNetPaper/fastMRIBaseline/IXI/UNet"
output_folder = r"1DVarden30Mask_HH_AllSlices" 
IsRadial = False
...
netModel = Net(use_supplied_loss=False)
...
train_path_under = '/home/soumick/Datasets/AlexMultiCon2/IXI-Dataset/T1/Guys-Train' #NOT NEEDED FOR WORKING WITH MATS
...
if not RunOnly4Combine:
    ...
    [optimizer], _ = netModel.configure_optimizers()
    model.CreateModel(netModel, IsCuda = IsCuda, IsMultiGPU = IsMultiGPU, n_channels=n_channels, optimizer=optimizer,
