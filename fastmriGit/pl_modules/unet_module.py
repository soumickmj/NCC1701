...
class UnetModule(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.use_supplied_loss = use_supplied_loss
    ...
    def forward(self, image, target, criterion):
        output = self.unet(image)
        if self.use_supplied_loss:
            loss = 1-criterion(output, target) #assuming SSIM loss
        else:
