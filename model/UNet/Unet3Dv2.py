...
Uses 3D Images
Source: https://github.com/pykao/Modified-3D-UNet-Pytorch/blob/master/model.py
With static hyper parameters
To call this UNet: net = Modified3DUNet(in_channels, n_classes, base_n_filter)
...
class UNet(nn.Module):
	def __init__(self, n_channels, base_n_filter = 32):
